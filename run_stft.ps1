...
# on the STFT spectrogram dataset. Automatically SKIPS models
...
Write-Host "  Starting STFT run  ($start)" -ForegroundColor Yellow
Write-Host "====================================================" -ForegroundColor Yellow
...
Write-Host ""
Write-Host "====================================================" -ForegroundColor Yellow
Write-Host "  STFT run complete." -ForegroundColor Yellow
